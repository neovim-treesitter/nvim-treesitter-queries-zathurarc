# nvim-treesitter-queries-zathurarc

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-zathurarc/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-zathurarc/actions/workflows/validate.yml)

Neovim tree-sitter queries for **zathurarc**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-zathurarc",
...
- [ ] Changes are scoped to `zathurarc` — do not include files for other languages
